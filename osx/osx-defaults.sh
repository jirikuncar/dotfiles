...
# Hibernate after sleeping for 2 hours
...
# Enable enlarge hover effect
defaults write com.apple.dock magnification -bool true
defaults write com.apple.dock largesize -int 46

# Enable minize to application icon
...
for app in "Dashboard" "Dock" "Finder" "Mail" "Safari" "SystemUIServer" "Terminal"; 
do
